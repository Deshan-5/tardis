...
class BenchmarkBasePlasma(BenchmarkBase):
    ...
    def time_update_plasma(self):
        # j_blues is the input updated each MC iteration;
        # this times the full downstream propagation through the graph to update the plasma state.
    ...
    def time_resolve_update_list(self):
        # isolates the nx.descendants + topological_sort cost of resolving the update list for a single variable.
